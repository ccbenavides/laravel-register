...
@section('content')
	...
	@include('backend.layouts.cabezera_panel',['param'=>'catalogo_categoria'])
	@include('backend.layouts.conteo_tabla',['param'=>'catalogo_categoria'])
		...
		<thead>
			<tr>
                <th class="pos_relative">
                    <a href="{{route('backend.catalogo_categoria.index',
	...
	src="{{ asset('imagenes/catalogo_imagen/miniatura/'.$categoria_producto->imagen)}}" alt=""> 
						@else
							sin imagen
						@endif
				</td>
				...
				<td>
					<div class="dropdown-button  place-right">
					    ...
					    <ul class="split-content d-menu place-right" data-role="dropdown">
					        <li><a href="{{ route('backend.catalogo_categoria.edit',$categoria_producto->id ) }}">Editar</a></li>
	...
	@include('backend.layouts.modal_destroy',['param'=>'catalogo_categoria'])
@endsection