         <div class="row">
            <div class="mi_cell_50">
                <div class="val_nombreCategoria">
                    <p class="label_form" for="categoria " > <span class="mif-lock"></span> Nombre Subcategoría:</p>
        ...
        <div class="val_selectcategoria">
                ...
                <div class="input-control text full-size " data-role="select">
                               {!! Form::select('categoria_id',$lista_categorias,null,[
                                    'id'=>'select_categoria',
...
<div class="place-right">
    <input type="submit" id="validate_subcategoria" class="button primary">
</div>